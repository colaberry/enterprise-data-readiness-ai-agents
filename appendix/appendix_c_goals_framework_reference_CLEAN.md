...
**Critical GOALS:** S (Soundness), A (Accessibility) - user experience, ease of use

**Target Scores:**
- S (Soundness): 5/5 (99.99%+ uptime, patients don't tolerate downtime)
- A (Accessibility): 4/5 (Business users can operate)
- L (Language): 4/5 (REST + JavaScript SDK for web)
- O (Observability): 4/5 (Can debug patient issues)
- G (Governance): 3/5 (Basic ABAC for patient data)
...
3. Is it affecting users? (user-facing or internal?)
