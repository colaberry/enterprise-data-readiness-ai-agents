...
**Infrastructure Requirements:**
- ABAC policy engine ([Azure](https://azure.microsoft.com) AD, OPA, [AWS](https://aws.amazon.com) Verified Permissions)
...
**Why It Matters:** Incomplete context leads to wrong answers. Healthcare agents need Electronic Health Record (EHR) + lab + pharmacy + billing context. Finance agents need CRM + ERP + market data.
...
### Ã¢ÂÅ’ Anti-Pattern 4: "Batch Extract, Transform, Load (ETL) is Fine for Agents"
